...
# wl_1 = 532e-9 # central wavelength of the Gaussian
# sigma_1 = 0.01e-9 # standard deviation of the Gaussian
# amp_1=1.0
# y=add_gaussian(x,y,wl_1,amp_1,sigma_1,nmodes)

# wl_2 = 533e-9 # central wavelength of the Gaussian
# sigma_2 = 0.01e-9 # standard deviation of the Gaussian
# amp_2=1.0
# y=add_gaussian(x,y,wl_2,amp_2,sigma_2,nmodes)

# wl_3 = 534e-9 # central wavelength of the Gaussian
# sigma_3 = 0.01e-9 # standard deviation of the Gaussian
# amp_3=1.0
# y=add_gaussian(x,y,wl_3,amp_3,sigma_3,nmodes)


# add a square wave
start_wavelength = 400e-9 # metres
width = 100e-9 # metres
amp = 1.0 # amplitude
